...
export class AuthService {
  ...
  async sendEmailToRecoveryPassword(email: string) {
    try {
      ...
      await this.usersService.generateProvisionalPassword(
        user.id,
  ...
  async recoveryPassword(data: RecoveryPasswordDto) {
    try {
      ...
      const provPassword =
        await this.usersService.findPasswordAndProvisionalPasswordByEmail(
          email,
        );
      ...
      this.usersService.disableProvisionalPasswordByUserId(
